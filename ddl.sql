...
CREATE TABLE lj_house_price(
	id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT COMMENT '主键',
	house_id BIGINT COMMENT 'lj 编号',
	total_price int COMMENT '总价',
	unit_price int COMMENT '单价',
	created_date DATETIME COMMENT '创建时间',
	modified_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间')ENGINE = InnoDB COMMENT 'lj price' DEFAULT CHARSET=utf8;
